...
namespace TheArtOfDev.HtmlRenderer.Demo.WPF
{
    ...
    /// </summary>
    public partial class DemoWindow : INotifyPropertyChanged, ICommand
    {
        ...
        public void Execute(object parameter)
        {
            try
            {
                ...
                var page = client.DownloadData(Url);
                string html = Encoding.ASCII.GetString(page);
                _mainControl.SetHtml(url, html);
            }
            catch 
            { }
        }
